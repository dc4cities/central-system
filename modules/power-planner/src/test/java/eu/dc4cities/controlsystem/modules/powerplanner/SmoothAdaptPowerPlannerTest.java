...
public class SmoothAdaptPowerPlannerTest {

	@Test
	public void largeInputPowerPlannerNoCurrentPlan() {
		SmoothAdaptPowerPlannerImpl idealPowerPlanner = new SmoothAdaptPowerPlannerImpl();
		idealPowerPlanner.setDCMinPower(900);
		idealPowerPlanner.setDCMaxPower(3000);
		...
		ErdsForecast renForecast = prepareConstantForecast(10000, 0.5, 0, 0, 100, 0, timeSlotNumber, dateFrom1, dateTo, timeSlotDuration, "ren");
