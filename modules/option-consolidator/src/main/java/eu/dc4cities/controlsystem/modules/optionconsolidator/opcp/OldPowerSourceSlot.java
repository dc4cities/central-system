 ...
 *
 */
public class OldPowerSourceSlot {

    /**
     * Peak Capacity in Watt.
     */
    private Amount<Power> peak;
     ...
     */
    public OldPowerSourceSlot(Amount<Power> pp, int rPct, long co2factor) {
        this(pp, rPct, 1);
    }
     ...
     * @param rPct the percentage of renewable energy for this period. Between 0 and 100
     */
    public OldPowerSourceSlot(Amount<Power> pp, int rPct, float co2emission) {
        peak = pp;
        renewablePct = rPct;
        this.price = price;
    }
     ...
     */
    public OldPowerSourceSlot(Amount<Power> pp, int rPct, int price) {
        peak = pp;
        renewablePct = rPct;
        this.price = price;
    }
