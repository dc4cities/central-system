...
@Deprecated
public class RenewablePowerMetric extends PowerMetric {

    float renewablePercentage;
    ...
    public void setRenewablePercentage(float renewablePercentage) {
    ...
    public void setCarbonEmissionFactor(float carbonEmissionFactor) {
